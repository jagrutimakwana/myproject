...
@section('main_container')
    ...
    <section class="slider_section ">
      <div class="slider_bg_box">
        <img src="{{url('website/images/slider-bg.jpg')}}" alt="">
      </div>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('website/images/feature-1.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Fast Delivery
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('website/images/feature-2.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Free Shiping
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('website/images/feature-3.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Best Quality
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('website/images/feature-4.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
    ...
    <div class="container">
      ...
      <div class="product_container">
        <div class="box">
          <div class="box-content">
            <div class="img-box">
              <img src="{{url('website/images/w7.png')}}" alt="">
            </div>
            <div class="detail-box">
              <div class="text">
                <h6>
        ...
        <div class="box">
          <div class="box-content">
            <div class="img-box">
              <img src="{{url('website/images/w8.png')}}" alt="">
            </div>
            <div class="detail-box">
              <div class="text">
                <h6>
        ...
        <div class="box">
          <div class="box-content">
            <div class="img-box">
              <img src="{{url('website/images/w9.png')}}" alt="">
            </div>
            <div class="detail-box">
              <div class="text">
                <h6>
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-10 mx-auto">
                <div class="box">
                  <div class="img-box">
                    <img src="{{url('website/images/client.jpg')}}" alt="">
                  </div>
                  <div class="detail-box">
