             ...
             <form action="{{url('/login_auth')}}" method="post">
                     @csrf      
							...
							<label><b>Email: </b></label>
                                <input type="email" class="form-control p-4" name="email" value="{{old('email')}}" placeholder="Your Email" >
								@error('email')
							...
							<label><b>Password: </b></label>
                                <input type="password" class="form-control p-4" name="password" value="{{old('password')}}" placeholder="Your Password" >
								@error('password')
				                    <div class="alert alert-danger">{{ $message }}</div>
			                    @enderror
                                <p class="help-block text-danger"></p>
