    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('images/feature-1.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Fast Delivery
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('images/feature-2.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Free Shiping
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('images/feature-3.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
                Best Quality
        ...
        <div class="col-md-6 col-lg-3">
          <div class="box ">
            <div class="img-box">
              <img src="{{url('images/feature-4.png')}}" alt="">
            </div>
            <div class="detail-box">
              <h5>
        ...
        <div class="col-md-6">
          <div class="img_container">
            <div class="img-box b1">
              <img src="{{url('images/a-1.jpg')}}" alt="">
            </div>
            <div class="img-box b2">
              <img src="{{url('images/a-2.jpg')}}" alt="">
            </div>
          </div>
        </div>
        <div class="col-md-6">
          ...
          <div class="container">
            <div class="row">
              <div class="col-md-10 mx-auto">
                <div class="box">
                  <div class="img-box">
                    <img src="{{url('images/client.jpg')}}" alt="">
                  </div>
                  <div class="detail-box">
